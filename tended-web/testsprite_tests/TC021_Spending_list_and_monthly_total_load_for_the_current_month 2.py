...
async def run_test():
    ...
    try:
        ...
        # -> Fill the Email field with the test username (index 7), fill the Password field (index 10), then click the Sign in button (index 51).
        ...
        # -> Click the Spending tab to open the spending screen, then verify the list of current-month spending entries and that a monthly total is displayed.
        frame = context.pages[-1]
        # Click element
