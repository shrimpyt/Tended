...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with an invalid password, submit the form, wait for the response, and then verify the sign-in form is still displayed.
        ...
        await page.wait_for_timeout(3000); await elem.fill('invalid-password-123')
