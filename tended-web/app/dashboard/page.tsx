                        ...
                        <div className="flex items-center text-xs mb-1.5 gap-2">
                          ...
                          <div className="flex items-center gap-1 flex-shrink-0">
                            <button
                              ...
                              className="w-5 h-5 flex items-center justify-center rounded transition-all text-text-secondary hover:text-red hover:bg-red/10 disabled:opacity-20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red"
                            >
                              <Minus size={10} />
                            </button>
                            ...
                            <button
                              ...
                              className="w-5 h-5 flex items-center justify-center rounded transition-all text-text-secondary hover:text-green hover:bg-green/10 disabled:opacity-20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green"
                            >
                              <Plus size={10} />
                            </button>
                            ...
                            <button
                              ...
                              className="w-5 h-5 flex items-center justify-center rounded transition-all text-text-secondary hover:text-red hover:bg-red/10 disabled:opacity-20 ml-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red"
                            >
                              <Trash2 size={11} />
                            </button>
                          </div>
