  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-background">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-surface-elevated">
        <button onClick={onClose} aria-label="Close Scanner" className="p-2 -ml-2 text-text-secondary hover:text-text-primary rounded-full hover:bg-surface transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue">
          <X size={24} />
        </button>
