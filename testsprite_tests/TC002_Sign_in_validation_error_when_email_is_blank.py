...
async def run_test():
    ...
    try:
        ...
        # -> Fill the password field with the provided test password and submit the sign-in form (click the 'Sign in' button) to trigger validation for the empty email field.
