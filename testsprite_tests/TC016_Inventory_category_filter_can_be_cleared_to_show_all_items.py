...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email field with the test account and submit the sign-in form.
        ...
        # -> Click the Inventory tab to open the inventory view so a category filter can be applied.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div/div[2]/div[2]/div[2]/div[2]/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)

        # -> Click the 'Kitchen' category filter to apply the category filter, then clear it by clicking 'All'.
        frame = context.pages[-1]
        # Click element
        ...
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div/div[2]/div/div[2]/div/div/div/div[2]/div/div/div').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
