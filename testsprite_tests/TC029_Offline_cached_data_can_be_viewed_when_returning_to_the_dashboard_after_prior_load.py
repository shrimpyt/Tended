...
async def run_test():
    ...
    try:
        ...
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div/div/div/div[2]/div').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        
        # -> Click the Inventory tab (index 143), then return to Dashboard (index 136) and verify dashboard content is still present (cached data).
        frame = context.pages[-1]
        # Click element
