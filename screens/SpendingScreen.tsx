...
import {useSpendingStore, SpendingEntry, SpendingCategory} from '../store/spendingStore';
...
export default function SpendingScreen() {
  ...
  const refresh = useCallback(() => {
    if (householdId) fetchEntries(householdId, year, month);
  ...
  useRealtimeHousehold(householdId, {onSpendingChange: refresh});
